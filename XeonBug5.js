		    ...
		    youtube https://www.youtube.com/@HacktivistHive`,
                    contextInfo: {
                        externalAdReply: {
                            ...
                            thumbnailUrl: 'https://mallucampaign.in/images/img_1714767949.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
...
break
            ...
            case 'help':
            case 'alive':
                let xeonmenuoh = `╭══ *❍ ELIAH_TECH-BUG_BOT ❍*
┃❁ *ᴏᴡɴᴇʀ:* David ○■□● Cyril
┃❁ *ᴜᴘᴛɪᴍᴇ:* ${runtime(process.uptime())}
┃❁ *User:* ${pushname}
╰┈➤ ${xeonytimewisher} 😄  My bro
⚠️⚠️ ~Don't forget to star my repo~ 
*Eliah_Tech-Bugbot* ~Github Repo~ ⚠️⚠️
_Repo link https://github.com/Eliahhango/Eliah_Tech-Bugbot _
╰═════════════════⊷
╭═══❂ 𝗕𝗨𝗚 𝗠𝗘𝗡𝗨 ❂
┃ ❏ *xʀᴇᴀᴄᴛ <ʀᴇᴘʟʏ ᴄʜᴀᴛ>*
┃ ❏ *x <ɴᴜᴍʙᴇʀ|ᴀᴍᴏᴜɴᴛ>*
