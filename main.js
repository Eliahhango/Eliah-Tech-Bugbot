...
XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
	        ...
	        console.log(chalk.magenta(`\n${themeemoji} YT CHANNEL: EliTechWiz`))
            console.log(chalk.magenta(`${themeemoji} GITHUB: Eliahhango`))
            console.log(chalk.magenta(`${themeemoji} INSTAGRAM: @elitechwiz `))
            console.log(chalk.magenta(`${themeemoji} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${themeemoji} CREDIT: Eliah Tech sir`))
        }
        if (
            connection === "close" &&
            lastDisconnect &&
